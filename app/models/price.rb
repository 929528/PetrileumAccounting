class Price < ActiveRecord::Base
	...
	validates :value, presence: {message: "^Цена отсутствует"}
	...
	def demand_rate
		if (self.updated_at.to_time > (Time.now - 10.seconds))
			difference = (10.seconds - (Time.now - self.updated_at.to_time)).to_i
